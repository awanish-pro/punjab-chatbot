    ...
    switch (lang) {
      case "hindi":
        return {
          ...
          placeholderPtid: "प्रॉपर्टी टैक्स आईडी दर्ज करें (उदा. PJB-123-456-78)",
          ...
          testPtid: "टेस्ट PTID: PJB-123-456-78",
          ...
          payAndProceed: "भुगतान करें और आगे बढ़ें",
          makePayment: "भुगतान करें (Make Payment)",
          micListeningPrompt: "सुन रहे हैं... अपना प्रश्न बोलें (उदा. 'प्रॉपर्टी टैक्स चेक करें')",
          secondLineHint: "अगली लाइन के लिए: Shift + Enter",
          ...
          mobileDigitsOnlyError: "मोबाइल नंबर में केवल अंक (0-9) होने चाहिए। अक्षर या विशेष वर्ण मान्य नहीं हैं।",
      ...
      case "hinglish":
        return {
          ...
          placeholderPtid: "Property Tax ID enter karein (jaise PJB-123-456-78)",
          ...
          testPtid: "Use test PTID: PJB-123-456-78",
          ...
          payNow: "Pay Now",
          payAndProceed: "Pay and Proceed",
          makePayment: "Make Payment",
          micListeningPrompt: "Sun rahe hain... Apni query bolein (e.g. 'Property tax check karein')",
          secondLineHint: "Next line ke liye: Shift + Enter",
          ...
          mobileDigitsOnlyError: "Mobile number mein sirf numbers (0-9) enter karein. Characters ya letters allowed nahi hain.",
          totalOutstanding: "Total Outstanding:",
          outstandingPayPrompt: (amt: string) => `Aapki total outstanding amount ₹${amt} hai. Kya aap abhi pay karna chahte hain?`,
      ...
      case "punjabi":
        return {
          ...
          placeholderPtid: "ਪ੍ਰਾਪਰਟੀ ਟੈਕਸ ਆਈਡੀ ਦਰਜ ਕਰੋ (ਜਿਵੇਂ PJB-123-456-78)",
          ...
          testPtid: "ਟੈਸਟ PTID: PJB-123-456-78",
          ...
          payAndProceed: "ਭੁਗਤਾਨ ਕਰੋ ਅਤੇ ਅੱਗੇ ਵਧੋ",
          makePayment: "ਭੁਗਤਾਨ ਕਰੋ (Make Payment)",
          micListeningPrompt: "ਸੁਣ ਰਹੇ ਹਾਂ... ਆਪਣਾ ਸਵਾਲ ਬੋਲੋ (ਜਿਵੇਂ 'ਪ੍ਰਾਪਰਟੀ ਟੈਕਸ ਚੈੱਕ ਕਰੋ')",
          secondLineHint: "ਅਗਲੀ ਲਾਈਨ ਲਈ: Shift + Enter",
          ...
          mobileDigitsOnlyError: "ਮੋਬਾਈਲ ਨੰਬਰ ਵਿੱਚ ਸਿਰਫ਼ ਅੰਕ (0-9) ਹੋਣੇ ਚਾਹੀਦੇ ਹਨ। ਅੱਖਰ ਜਾਂ ਚਿੰਨ੍ਹ ਮਨਜ਼ੂਰ ਨਹੀਂ ਹਨ।",
      ...
      default:
        return {
          ...
          placeholderPtid: "Enter Property Tax ID (e.g. PJB-123-456-78)",
          ...
          payAndProceed: "Pay and Proceed",
          makePayment: "Make Payment",
          micListeningPrompt: "Listening... Speak your query now (e.g. 'Check property tax')",
          secondLineHint: "Shift + Enter for new line",
          resendOtp: "Resend OTP",
          changeIdentifier: "Change Identifier",
          ...
          mobileDigitsOnlyError: "Mobile number can only contain digits (0-9). Characters and letters are not allowed.",
          totalOutstanding: "Total Outstanding:",
